...
class CyberAttackSummary:
	...
	def get_mssql_connection(self):
		connection = pyodbc.connect('driver={ODBC Driver 17 for SQL Server};server=<DBHOST>;database=<DBNAME>;uid=<DBUSER>;pwd=<DBPWD>;ColumnEncryption=Enabled;')
		return connection
